...
const mspId = envOrDefault('MSP_ID', 'ManufacturerMSP');
...
const tlsCertPath = envOrDefault(
    'TLS_CERT_PATH',
    path.resolve(cryptoPath, 'peers', 'peer0.manufacturer.amu.com', 'tls', 'ca.crt')
);
...
const peerHostAlias = envOrDefault('PEER_HOST_ALIAS', 'peer0.manufacturer.amu.com');
